...
document.getElementById('i7ads').onclick = (event) => {
    ...
    product['pImage'] = {
      ...
      product['pTitle'] = document.querySelector("[annotationname = 'pTitle']").value;product['pCount'] = document.querySelector("[annotationname = 'pCount']").value;apiProductApi.createproduct( product, (error, data, response) => { if (error) {console.error(error);} else { console.log('API called successfully. Returned data: ' + data); }});};window.onload = () => {};